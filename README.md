...
**מגבלה שחשוב להכיר:** שני המודלים בנויים על מבנה דוחות של חברה תפעולית — מרווח
גולמי, יחס חייבים למכירות, נכסים שוטפים מול התחייבויות שוטפות. לבנקים ולחברות
ביטוח אין מהם כמעט דבר, ולכן שתי הפסילות מסומנות אצלן כלא רלוונטיות. מכיוון שרוב
עוברי גראהם הם פיננסיים, שלב הפסילה מכסה בפועל רק חלק מהרשימה.
